...
// -- Project -------------------------------------
#define PROJECT                "sonoff_yo"          // PROJECT is used as the default topic delimiter
...
#define STA_SSID1              "MiFibra-5D5E"                // [Ssid1] Wifi SSID
#define STA_PASS1              "nq7FjbCn"                // [Password1] Wifi password
...
//#define MQTT_HOST              "formacio.things.cat"                // [MqttHost]
#define MQTT_HOST              "10.244.59.173"                // [MqttHost]
...
//#define MQTT_USER              "ecat"       // [MqttUser] MQTT user
#define MQTT_USER              "xadnem"       // [MqttUser] MQTT user
//#define MQTT_PASS              "clotClot"       // [MqttPassword] MQTT password
#define MQTT_PASS              "(Babilon3_X)"       // [MqttPassword] MQTT password
